...
3. Navigate to Settings, and under Cloud Connectivity, click the blue **Enable** button. This will automatically reboot the aircraft.

<figure><img src="../../.gitbook/assets/EnablingCloudServices.gif" alt="" width="563"><figcaption></figcaption></figure>

{% hint style="info" %}
This will not inherently upload any data to the cloud. Enabling Cloud Connectivity is a prerequesite for Astro's log streaming backend service to run, which is needed for the PPK files to be generated after a flight.&#x20;
{% endhint %}
{% endstep %}
