...
* Astro's stock landing gear is a bit too short for the height of the gimbal. The extended Astro landing gear is recommended to use with this gimbal

{% embed url="https://store.freeflysystems.com/collections/astro/products/astro-max-landing-gear" %}
...
{% hint style="warning" %}
We've seen issues where the gimbal sometimes incorrectly reports a successful change of baud rate, so reboot the gimbal and check the settings to make sure it was changed correctly.
{% endhint %}
