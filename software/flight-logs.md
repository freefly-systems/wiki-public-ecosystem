...
* A PC with **AMC PC** (Auterion Mission Control) installed
  * You can download the latest AMC for desktop (Mac, Windows, Linux) from the [Astro Software Release Notes](https://docs.freeflysystems.com/astro/maintenance/software-release-notes#latest-versions) page.
...
| Detail            | Description                                                                                                                                                                                                                                                                                                                            |
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Format**        | `RADIO-LOG-YYYY-MM-DD.txt`                                                                                                                                                                                                                                                                                                             |
