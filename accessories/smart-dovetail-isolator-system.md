...
{% embed url="https://store.freeflysystems.com/products/astro-isolator" %}

For installation instructions, see:

{% embed url="https://docs.freeflysystems.com/astro/ecosystem/components/vibration-isolators" %}
